                ...
                {cases.map(caseItem => (
                  ...
                  >
                    <div className="flex justify-between items-start mb-4">
                      ...
                      <span
                        className={`text-xs font-semibold px-2 py-1 rounded-full ${getPriorityColor(caseItem.priority || 'Medium')}`}
                      >
                    ...
                    {caseItem.successProbability && (
                      <div className="space-y-3">
                        <div className="flex justify-between items-center text-sm">
                          ...
                          <span
                            className={`font-bold ${getSuccessProbabilityColor(caseItem.successProbability)}`}
                          >
