        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1">
                <span
                  className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getDatabaseStatusColor(healthData.database)}`}
                >
                  {healthData.database}
                </span>
              </div>
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1">
                <span
                  className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getMemoryUsageStatus(healthData.memoryUsageMB)}`}
                >
        ...
        <div className="bg-white dark:bg-gray-800 rounded-lg p-4 sm:p-6 shadow-sm">
          <div className="flex items-center">
            ...
            <div className="ml-4">
              ...
              <div className="mt-1">
                <span
                  className={`inline-flex px-2 py-1 text-xs font-semibold rounded-full ${getErrorStatus(healthData.recentErrors)}`}
                >
        ...
        <div className="px-4 sm:px-6 py-4">
          <dl className="grid grid-cols-1 gap-x-4 gap-y-4 sm:gap-y-6 sm:grid-cols-2">
            ...
            <div>
              ...
              <dd className="mt-1 text-sm text-gray-900 dark:text-white">
                {healthData.recentErrors} errors in last 24 hours
              </dd>
            </div>
            <div>
