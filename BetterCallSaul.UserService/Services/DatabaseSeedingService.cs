...
namespace BetterCallSaul.UserService.Services;
...
public class DatabaseSeedingService
{
    ...
    public DatabaseSeedingService(UserServiceContext context, ILogger<DatabaseSeedingService> logger, RoleManager<Role> roleManager)
    {
        _context = context;
        _logger = logger;
