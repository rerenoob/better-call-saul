...
public class JustiaClient
{
    private readonly HttpClient _httpClient;
    private readonly ILogger<JustiaClient> _logger;
    private const string BaseUrl = "https://api.justia.com/v1";

    public JustiaClient(HttpClient httpClient, ILogger<JustiaClient> logger)
    {
    ...
    public async Task<T?> GetAsync<T>(string endpoint, CancellationToken cancellationToken = default)
    {
        ...
        {
            _logger.LogError(ex, "Unexpected error occurred while calling Justia API");
            throw;
        }
    }
